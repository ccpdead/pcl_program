...
int main(int argc, char **argv)
{
    ...
    //Create a list to hold the target quaternions 
    ...
    //a pose consition of a position and orientation in the map frame;
    ...
    //set a visualizations marker at each waypoint
    for(int i =0;i<4;i++)
    {
